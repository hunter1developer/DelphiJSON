...
begin
  FDriverList := TDriverList.Create('C:\Dev\Delphi\TestJson\driver.json');
end;
...
begin
  FAutoList := TAutoList.Create('C:\Dev\Delphi\TestJson\auto.json');
end;
...
begin
  FTripList := TTripList.Create('C:\Dev\Delphi\TestJson\trip.json');
end;
...
begin
  ...
  Check(FTripList[0].StartTime = StrToDate('6/18/2021'));

  Check(FTripList[1].AutoID    = 3);
  Check(FTripList[1].DriverID  = 4);
  Check(FTripList[1].StartTime = StrToDate('6/18/2021'));

  Check(FTripList[2].AutoID    = 5);
  Check(FTripList[2].DriverID  = 6);
  Check(FTripList[2].StartTime = StrToDate('6/18/2021'));
end;
...
begin
  FTripList.Clear;
  FTripList.Add(FTripList.CreateTrip(1, 2, StrToDate('6/18/2021')));
  FTripList.Add(FTripList.CreateTrip(3, 4, StrToDate('6/18/2021')));
  FTripList.Add(FTripList.CreateTrip(5, 6, StrToDate('6/18/2021')));
